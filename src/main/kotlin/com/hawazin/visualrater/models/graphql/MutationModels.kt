...
data class NewAlbumInput(val name:String, val thumbnail:String?, val year:Int, val artistId:UUID, val artist:ArtistInput, val songs:Array<NewSongInput>, var dominantColor:String?)
