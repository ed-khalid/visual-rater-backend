...
data class ArtistInput(val id:String, val name:String, val thumbnail:String?)
data class AlbumInput(val id:String,val name:String,val year:Int, val thumbnail:String?)